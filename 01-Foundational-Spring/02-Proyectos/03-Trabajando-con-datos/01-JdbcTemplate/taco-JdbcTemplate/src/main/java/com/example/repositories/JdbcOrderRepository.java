...
import com.example.model.IngredientRef;
...
public class JdbcOrderRepository implements OrderRepository {
    ...
    public TacoOrder save(TacoOrder order) {
        // Crea un PreparedStatementCreatorFactory para insertar en Taco_Order
        ...
        // Habilita la obtención de la clave generada
        pscf.setReturnGeneratedKeys(true);

        // Establece la fecha de creación del pedido
        order.setPlacedAt(new Date());

        // Crea un PrepareStatementCreator con los valores del pedido
    ...
    private long saveTaco(Long orderId, int orderKey, Taco taco) {
        ...
        // Crear un PrepareStatementCreatorFactory para insertar en Taco
        PreparedStatementCreatorFactory pscf = new PreparedStatementCreatorFactory(
                "INSERT INTO Taco (name, created_aat, taco_order, taco_order_key) " +
                "VALUES (?, ?, ?, ?)",
